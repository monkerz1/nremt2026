        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-3">
              ...
              <li>Attempting to decompile or reverse engineer any software contained on EMTQUIZ</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which EMTQUIZ operates, and you irrevocably submit to the exclusive jurisdiction of the courts in that location.
            </p>
          </section>
